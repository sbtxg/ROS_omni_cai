...
int main(int argc, char** argv) {
    ...
    ros::init(argc, argv, "odom_plot");       //初始化节点
    ros::NodeHandle n1;
    ros::NodeHandle n2;
    ros::Publisher odom_pub = n1.advertise<nav_msgs::Odometry>("odom", 10);
    ros::Publisher speedx_pub = n2.advertise<std_msgs::Float64>("speedx", 100);
    
    std_msgs::Float64 speedx_msg;
